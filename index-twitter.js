...
const TW_key = 'TpHPYxi8fGQUwWtrgT7r2gtvu';
const TW_secret_key = 'wTzDeeGuveXXdhTzUSNsQhRtzkpRaDXRR7tVbZPbID5jeXF4dX';
...
app.get("/auth/twitter/callback", passport.authenticate ('twitter', {failureRedirect: '/registro', successRedirect: '/datos'}));
